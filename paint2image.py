...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_dir', help='input image dir', default='Sin-GAN-master/Input')
    parser.add_argument('--input_name', help='training image name', required=True)
    parser.add_argument('--ref_dir', help='input reference dir', default='Sin-GAN-master/Input')
