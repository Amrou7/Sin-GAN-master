...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_dir', help='input image dir', default='Sin-GAN-master/Input/Filtered')
    parser.add_argument('--input_name', help='training image name', required=True)
    parser.add_argument('--ref_dir', help='input reference dir', default='Sin-GAN-master/Input/GaussianNoise')
    ...
    #    print("output already exist")
        ...
        if (opt.paint_start_scale < 1) | (opt.paint_start_scale > (len(Gs)-1)):
            ...
            imageio.imsave('%s/start_scale=%d.png' % (dir2save, opt.paint_start_scale), functions.convert_image_np(out.detach()))
